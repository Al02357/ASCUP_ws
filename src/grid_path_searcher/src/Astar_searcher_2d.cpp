...
inline void AstarPathFinder2d::AstarGetSucc(GridNodePtr2d currentPtr, vector<GridNodePtr2d> & neighborPtrSets, vector<double> & edgeCostSets)
{   
    ...
    */
    ...
    while ( !openSet.empty() ){
        ...
        */
        ...
        //get the succetion
        AstarGetSucc(currentPtr, neighborPtrSets, edgeCostSets);  //STEP 4: finish AstarPathFinder2d::AstarGetSucc yourself     
        // 获取该点周围的所有节点和周围点的edgeCostSets(edgeCostSets:该点到目标的的距离)
