...
sleep 2 &&
RUN_AFTER_BASHRC="rosrun my_fsm single_cmd" gnome-terminal --title="connection" --tab;
RUN_AFTER_BASHRC="rosrun my_fsm sim_joystick" gnome-terminal --title="control" --window & 
sleep 1 ;
